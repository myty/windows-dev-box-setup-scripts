...
|---------|---------|
|<a href='http://boxstarter.org/package/url?https://raw.githubusercontent.com/myty/windows-dev-box-setup-scripts/develop/dev_app_mytydev.ps1'>MyTy App Dev Environment</a>     | Windows Desktop App Development (Visual Studio, Windows SDK, C++, UWP, .NET (WPF and Winforms)) + Web Development |
